...
},{"./lib/axios":"node_modules/axios/lib/axios.js"}],"src/services/base.js":[function(require,module,exports) {
"use strict";
...
exports.HTTP = HTTP;
},{"axios":"node_modules/axios/index.js"}],"src/services/movies.js":[function(require,module,exports) {
"use strict";
...
var _default = {
  getMovies: function getMovies() {
    return _base.HTTP.get('movies/');
  }
};
exports.default = _default;
},{"./base":"src/services/base.js"}],"src/components/movie.js":[function(require,module,exports) {
"use strict";
...
var Movie = /*#__PURE__*/function () {
  ...
  */
  ...
  _createClass(Movie, [{
    key: "averageRating",
    value: function averageRating() {
      var lenRatings = this.ratings.length;
      if (lenRatings <= 0) return 0;
      var sumRatings = this.ratings.reduce(function (prev, curr, idx, arr) {
        return prev + curr;
      });
      return (sumRatings / this.ratings.length).toFixed(2);
    }
    /** 
    ...
    */
    ...
    key: "actorsList",
    value: function actorsList() {
      var actorsHtmlList = '';

      for (var i = 0; i < this.actors.length; i++) {
        var actor = this.actors[i];
        actorsHtmlList += "<li>".concat(actor, "</li>");
      }
...
},{}],"src/components/playlist.js":[function(require,module,exports) {
"use strict";
...
var MoviePlaylist = /*#__PURE__*/function () {
  /**
  ...
  function MoviePlaylist(movies) {
    _classCallCheck(this, MoviePlaylist);
  ...
  _createClass(MoviePlaylist, [{
    key: "initialLoad",
    value: function initialLoad(movies) {
      var _this = this;

      for (var i = 0; i < movies.length; i++) {
        var movieData = movies[i];
        var movie = new _movie.default(movieData);
        this.mylist.push(movie);
        movieData.genres.forEach(function (genre) {
          if (!_this.genres.includes(genre)) {
    ...
    key: "orderBy",
    value: function orderBy(method, pivot) {
      if (method == 'rate') {
        console.log("rate");
        this.mySortedList = this.mylist.sort(function (a_movie, b_movie) {
          return a_movie.averageRating() - b_movie.averageRating();
        });
        if (pivot == 'high') this.mySortedList.reverse();
      } else if (method == 'actor') {
        console.log("actor");
        this.mySortedList = this.mylist.filter(function (movie) {
          return movie.actors.includes(pivot);
        });
      } else if (method == 'genre') {
        console.log("genre");
        this.mySortedList = this.mylist.filter(function (movie) {
          return movie.genres.includes(pivot);
        });
      }
    }
    /** 
    ...
    key: "getPlayListCode",
    value: function getPlayListCode() {
      var htmlList = '';

      for (var i = 0; i < this.mySortedList.length; i++) {
        var movieObj = this.mySortedList[i];
    ...
    key: "getOptions",
    value: function getOptions(bySort) {
      ...
      if (bySort == "rate") {
        ...
        for (var i = 0; i < this.actors.length; i++) {
          var actor = this.actors[i];
          options += "<option value=\"".concat(actor, "\" >").concat(actor, "</option>");
        }
      } else if (bySort == "genre") {
        for (var _i = 0; _i < this.genres.length; _i++) {
          var genre = this.genres[_i];
          options += "<option value=\"".concat(genre, "\" >").concat(genre, "</option>");
        }
      } else {
...
exports.default = MoviePlaylist;
},{"./movie":"src/components/movie.js"}],"src/index.js":[function(require,module,exports) {
"use strict";

var _movies = _interopRequireDefault(require("./services/movies"));
...
function initMovieFlix(data) {
  var playlist = new _playlist.default(data);
  var container = document.getElementById('postersContainer');
  var sortSelect = document.getElementById('sort-method');
  var pivotSelect = document.getElementById('sort-pivot');
  container.innerHTML = playlist.getPlayListCode();

  sortSelect.onchange = function () {
    var valueSelected = sortSelect.value;
    var pivotHtmlText = playlist.getOptions(valueSelected);
    pivotSelect.innerHTML = pivotHtmlText;
  };

  pivotSelect.onchange = function () {
    var sortSelected = sortSelect.value;
    var pivotSelected = pivotSelect.value;
...
_movies.default.getMovies().then(function (_ref) {
  var data = _ref.data;
  return initMovieFlix(data);
});
},{"./services/movies":"src/services/movies.js","./components/playlist":"src/components/playlist.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
